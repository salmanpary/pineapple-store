...
const Easy = () => {
  return (
      ...
      <Feature icon="charm:people" heading="Create a Trela ​​Group for your neighborhood" description={["Just click on Create a Group and we'll open an exclusive WhatsApp group ", <br/>,  "for you and your neighbors."]}/>
      <Feature icon="akar-icons:share-box" heading="Forward invitations to your neighbors" description={["Just click on Create a Group and we'll open an exclusive WhatsApp group ", <br/>,  "for you and your neighbors."]}/>
